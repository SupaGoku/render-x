...
- Tasks: @.blueprint/specs/current/[FOLDER]/tasks.md
- Technical Specification: @.blueprint/specs/current/[FOLDER]/sub-specs/technical-spec.md
  [ADDITIONAL_DOCS]
```
...
This is the technical specification for the spec detailed in @.blueprint/specs/current/[FOLDER]/spec.md
...
This is the database schema implementation for the spec detailed in @.blueprint/specs/current/[FOLDER]/spec.md
...
This is the API specification for the spec detailed in @.blueprint/specs/current/[FOLDER]/spec.md
...
These are the tasks to be completed for the spec detailed in @.blueprint/specs/current/[FOLDER]/spec.md
...
```
Create file: .blueprint/specs/current/2025-01-29-auth/spec.md
...
Directory: .blueprint/specs/current/2025-01-29-user-auth/
Files:
...
```
✓ Created directory: .blueprint/specs/2025-01-29-user-auth/
